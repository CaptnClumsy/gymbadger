...
insert into gyms (id, name, lat, long, park, areaid, image_url) values (nextval('gymids'), 'Woodbury Field Entry Marker', 51.709302, -0.363664, false, (SELECT id FROM areas WHERE name='Bricket Wood'), null);
commit;