...
insert into gyms (id, name, lat, long, park, areaid, image_url) values (nextval('gymids'), 'Woodbury Field Entry Marker', 51.709503, -0.364253, false, (SELECT id FROM areas WHERE name='Bricket Wood'), null);
commit;